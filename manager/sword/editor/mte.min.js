...
var MTE=function(e,t){function n(e,t){e=e||{};for(var i in t)e[i]="object"==typeof t[i]?n(e[i],t[i]):t[i];return e}var i=this,l=window,r=document,o=new Editor(e),c={tabSize:"    ",toolbar:!0,shortcut:!1,toolbarClass:"editor-toolbar",toolbarPosition:"before",iconClassPrefix:"fa fa-",buttons:{ok:"OK",yes:"Yes",no:"No",cancel:"Cancel",bold:"Bold",italic:"Italic",code:"Code",quote:"Quote",heading:"H1 \u2013 H6",link:"Link",image:"Image",ol:"Ordered List",ul:"Unordered List",rule:"Horizontal Rule",undo:"Undo",redo:"Redo"},prompt:{link_title:"link title goes here...",link_title_title:"Link Title",link_url:"http://",link_url_title:"Link URL",image_url:"http://",image_url_title:"Image URL"},placeholder:{heading_text:"Heading",link_text:"link text",list_ul_text:"List Item",list_ol_text:"List Item",image_alt:"Image"},keydown:function(){},click:function(){},ready:function(){}},a=r.createElement("div"),u=r.createElement("div");i.modal=function(e,t){e=e||"modal";var n=r.body;a.className="custom-modal-overlay custom-"+e+"-overlay",u.className="custom-modal custom-"+e,u.innerHTML='<div class="custom-modal-header custom-'+e+'-header"></div><div class="custom-modal-content custom-'+e+'-content"></div><div class="custom-modal-action custom-'+e+'-action"></div>',n.appendChild(a),n.appendChild(u),"function"==typeof t&&t(a,u)},i.close=function(e){if(a&&r.body.removeChild(a),u&&r.body.removeChild(u),"undefined"!=typeof e&&e===!0){var t=o.selection();o.select(t.start,t.end)}},i.prompt=function(e,t,n,l){i.modal("prompt",function(o,c){var a=function(e){"function"==typeof l?(i.close(),l(e)):i.close(!0)},u=r.createElement("input");u.type="text",u.value=t,u.onkeyup=function(e){n?13==e.keyCode&&""!==this.value&&this.value!==t&&a(this.value):13==e.keyCode&&a(this.value==t?"":this.value)};var f=r.createElement("button");f.innerHTML=s.buttons.ok,f.onclick=function(){n?""!==u.value&&u.value!==t&&a(u.value):a(u.value==t?"":u.value)};var d=r.createElement("button");d.innerHTML=s.buttons.cancel,d.onclick=function(){i.close(!0)},c.children[0].innerHTML=e?e:"",c.children[1].appendChild(u),c.children[2].appendChild(f),c.children[2].appendChild(r.createTextNode(" ")),c.children[2].appendChild(d),u.select()})},i.alert=function(e,t,n){i.modal("alert",function(l,o){var c=r.createElement("button");c.innerHTML=s.buttons.ok,c.onclick=function(){"function"==typeof n?(i.close(),n()):i.close(!0)},o.children[0].innerHTML=e?e:"",o.children[1].innerHTML=t?t:"",o.children[2].appendChild(c)})},i.confirm=function(e,t,n){i.modal("confirm",function(l,o){var c=r.createElement("button");c.innerHTML=s.buttons.ok,c.onclick=function(){"undefined"==typeof n?i.close(!0):"function"==typeof n.OK?(i.close(),n.OK()):i.close(!0)};var a=r.createElement("button");a.innerHTML=s.buttons.cancel,a.onclick=function(){return"undefined"==typeof n?i.close(!0):"function"==typeof n.CANCEL?(i.close(),n.CANCEL()):i.close(!0),!1},o.children[0].innerHTML=e?e:"",o.children[1].innerHTML=t?t:"",o.children[2].appendChild(c),o.children[2].appendChild(r.createTextNode(" ")),o.children[2].appendChild(a)})};var s=n(c,t),f=r.createElement("span");s.toolbar&&(f.className=s.toolbarClass,o.area.parentNode.insertBefore(f,"before"==s.toolbarPosition?o.area:null)),i.button=function(e,t){if(t.title!==!1){var n=r.createElement("a");n.href="#"+e,n.setAttribute("tabindex",-1),n.innerHTML='<i class="'+s.iconClassPrefix+e+'"></i>',n.onclick=function(n){return t.click(n,i),s.click(n,i,e),!1},t.title&&(n.title=t.title),t.position?f.insertBefore(n,f.children[t.position-1]):f.appendChild(n)}},o.toggle=function(e,t,n){var i=o.selection();if(i.before.slice(-e.length)!=e&&i.after.slice(0,t.length)!=t)o.wrap(e,t);else{var l=i.before.slice(-e.length)==e?i.before.substring(0,i.before.length-e.length):i.before,r=i.after.substring(0,t.length)==t?i.after.substring(t.length):i.after;o.area.value=l+i.value+r,o.select(l.length,l.length+i.value.length,function(){o.updateHistory()})}"function"==typeof n&&n()};var d=0,h=c.buttons,p={bold:{title:h.bold,click:function(){o.toggle("**","**")}},italic:{title:h.italic,click:function(){o.toggle("_","_")}},code:{title:h.code,click:function(){var e=o.selection().value;-1!==e.indexOf("\n")&&e.length>0?o.indent(s.tabSize):o.toggle("`","`")}},"quote-right":{title:h.quote,click:function(){o.indent("> ")}},header:{title:h.heading,click:function(){var e=o.selection(),t=["","# ","## ","### ","#### ","##### ","###### "];if(d=d<t.length-1?d+1:0,e.value.length>0)if(e.before.match(/\#+ $/)){var n=e.before.replace(/\#+ $/,""),i=e.value.replace(/^\#+ /,"");o.area.value=n+t[d]+i+e.after,o.select(n.length+t[d].length,n.length+t[d].length+i.length,function(){o.updateHistory()})}else o.wrap(t[d],"",function(){o.replace(/^\#+ /,"")});else{var l=s.placeholder.heading_text;d=1,o.insert(t[d]+l,function(){e=o.selection().end,o.select(e-l.length-t[d].length+2,e,function(){o.updateHistory()})})}}},link:{title:h.link,click:function(){var e,t,n=o.selection(),l=s.placeholder.link_text;i.prompt(s.prompt.link_title_title,s.prompt.link_title,!1,function(r){e=r,i.prompt(s.prompt.link_url_title,s.prompt.link_url,!0,function(i){t=i,o.wrap("["+(0===n.value.length?l:""),"]("+t+(""!==e?' "'+e+'"':"")+")",function(){o.select(n.start+1,0===n.value.length?n.start+l.length+1:n.end+1,function(){o.updateHistory()})})})})}},image:{title:h.image,click:function(){i.prompt(s.prompt.image_url_title,s.prompt.image_url,!0,function(e){var t=decodeURIComponent(e.substring(e.lastIndexOf("/")+1,e.lastIndexOf(".")).replace(/[\-\+\.\_]+/g," ")).toLowerCase().replace(/(?:^|\s)\S/g,function(e){return e.toUpperCase()});t=-1===t.indexOf("/")&&-1!==e.indexOf(".")?t:s.placeholder.image_alt,o.insert("\n!["+t+"]("+e+")\n")})}},"list-ol":{title:h.ol,click:function(){var e=o.selection(),t=0,n="";if(e.value==s.placeholder.list_ol_text)o.select(e.start,e.end);else if(e.value.length>0)o.indent("",function(){o.replace(/^[^\n\r]/gm,function(e){return t++,n+=" "+t+". ",e.replace(/^/," "+t+". ")})});else{var i=" 1. "+s.placeholder.list_ol_text;o.insert(i,function(){o.select(e.start+4,e.start+i.length,function(){o.updateHistory()})})}}},"list-ul":{title:h.ul,click:function(){var e=o.selection();if(e.value==s.placeholder.list_ul_text)o.select(e.start,e.end);else if(e.value.length>0)o.indent(" * ");else{var t=" * "+s.placeholder.list_ul_text;o.insert(t,function(){o.select(e.start+3,e.start+t.length,function(){o.updateHistory()})})}}},"ellipsis-h":{title:h.rule,click:function(){o.insert("\n---\n")}},"rotate-left":{title:h.undo,click:function(){o.undo()}},"rotate-right":{title:h.redo,click:function(){o.redo()}}};for(var g in p)i.button(g,p[g]);var v=function(e,t){return o.insert(e,function(){o.select(t.end+1,t.end+1)}),!1};o.area.onkeydown=function(e){var t=o.selection(),n=e.keyCode,r=e.ctrlKey,a=e.shiftKey,u=e.altKey;l.setTimeout(function(){s.keydown(e,i)},10);var f=t.before,d=t.after[0];if(-1!==f.indexOf("(")&&a&&48==n&&")"==d&&"\\"!=f.slice(-1)||-1!==f.indexOf("{")&&a&&221==n&&"}"==d&&"\\"!=f.slice(-1)||-1!==f.indexOf("[")&&221==n&&"]"==d&&"\\"!=f.slice(-1)||-1!==f.indexOf('"')&&a&&222==n&&'"'==d&&"\\"!=f.slice(-1)||-1!==f.indexOf("'")&&!a&&222==n&&"'"==d&&"\\"!=f.slice(-1)||-1!==f.indexOf("`")&&!a&&192==n&&"`"==d&&"\\"!=f.slice(-1)||-1!==f.indexOf("<")&&a&&190==n&&">"==d&&"\\"!=f.slice(-1))return o.select(t.end+1,t.end+1),!1;if(a&&57==n)return v("("+t.value+")",t);if(a&&219==n)return v("{"+t.value+"}",t);if(!a&&219==n)return v("["+t.value+"]",t);if(a&&222==n)return v('"'+t.value+'"',t);if(!a&&222==n)return v("'"+t.value+"'",t);if(!a&&192==n)return v("`"+t.value+"`",t);if(a&&188==n)return v("<"+t.value+">",t);if(a&&9==n)return o.outdent("( *[0-9]+. | *[\\-\\+\\*] |> |"+s.tabSize+")"),!1;if(9==n)return o.indent(s.tabSize),!1;if(r&&90==n)return o.undo(),!1;if(r&&89==n||r&&82==n)return o.redo(),!1;if(c.shortcut){if(r&&66==n)return p.bold.click(),!1;if(r&&73==n)return p.italic.click(),!1;if(r&&81==n)return p["quote-right"].click(),!1;if(u&&81==n)return a?o.toggle("&ldquo;","&rdquo;"):o.toggle("&lsquo;","&rsquo;"),!1;if(r&&72==n)return p.header.click(),!1;if(r&&76==n)return p.link.click(),!1;if(r&&71==n)return p.image.click(),!1}if(32==n){var h=/(^|\n)([0-9]+\.|[\-\+\*])$/;if(t.before.match(h))return o.area.value=t.before.replace(h,"$1 $2 ")+t.value+t.after,o.select(t.end+2,t.end+2,function(){o.updateHistory()}),!1}if(13==n){var g=/(^|\n)( *?)([0-9]+\.|[\-\+\*]) (.*?)$/;if(t.before.match(g)){var m=g.exec(t.before),b=/[0-9]+\./.test(m[3])?parseInt(m[3],10)+1+".":m[3];return o.insert("\n"+m[2]+b+" ",null),!1}var k=new RegExp("(^|\n)(("+s.tabSize+")+)(.*?)$").exec(t.before),_=k?k[2]:"";return t.before.match(/[\(\{\[]$/)&&t.after.match(/^[\]\}\)]/)||t.before.match(/<[^\/]*?>$/)&&t.after.match(/^<\//)?(o.insert("\n"+_+s.tabSize+"\n"+_,function(){o.select(t.start+_.length+s.tabSize.length+1,t.start+_.length+s.tabSize.length+1,function(){o.updateHistory()})}),!1):(o.insert("\n"+_),!1)}if(8==n&&0===t.value.length){if(t.before.match(/( *?)([0-9]+\.|[\-\+\*]) $/))return o.outdent("( *?)([0-9]+.|[-+*]) "),!1;if(t.before.match(new RegExp(s.tabSize+"$")))return o.outdent(s.tabSize),!1;switch(t.before.slice(-1)){case"(":return o.toggle("(",")"),!1;case"{":return o.toggle("{","}"),!1;case"[":return o.toggle("[","]"),!1;case'"':return o.toggle('"','"'),!1;case"'":return o.toggle("'","'"),!1;case"<":return o.toggle("<",">"),!1;case"*":return o.toggle("*","*"),!1;case"_":return o.toggle("_","_"),!1;case"~":return o.toggle("~","~"),!1;case"`":return o.toggle("`","`"),!1}}o.updateHistory()},s.ready(i),i.grip=o};
 ...
 * --------------------
 *
 * To keep the API remains semantics, starting from here you can call "MTE" as "Mecha Text Editor".
 *
 */
