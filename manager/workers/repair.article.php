...
<div class="tab-content-area">
  <?php echo $messages; ?>
  <form class="form-<?php echo $page->id ? 'repair' : 'ignite'; ?> form-article" id="form-<?php echo $page->id ? 'repair' : 'ignite'; ?>" action="<?php echo $config->url_current; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="tab-content" id="tab-content-1">
      ...
      <label class="grid-group">
        ...
        <span class="grid span-5">
        <?php echo Form::textarea('description', Guardian::wayback('description', $page->description), Config::speak('manager.placeholder_description_', strtolower($speak->article)), array(
      ...
      $tags = array();
      $tags_wayback = ',' . implode(',', Guardian::wayback('kind', Mecha::A($page->kind))) . ',';
