  ...
  <form class="form-compose" id="form-compose" action="<?php echo $config->url_current; ?>" method="post">
    ...
    <div class="tab-content" id="tab-content-1">
      ...
      <label class="grid-group">
        ...
        <span class="grid span-5"><textarea name="description" class="textarea-block" placeholder="<?php echo Config::speak('manager.placeholder_description', array(strtolower($speak->article))); ?>"><?php echo Text::parse(Guardian::wayback('description', $default->description))->to_encoded_html; ?></textarea></span>
      </label>
      <?php
