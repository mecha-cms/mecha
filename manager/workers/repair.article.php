...
<div class="tab-area">
  ...
  <a class="tab ajax-post" href="#tab-content-4" data-action-url="<?php echo $config->url . '/' . $config->manager->slug . '/ajax/preview:' . $segment; ?>" data-text-progress="<?php echo $speak->previewing; ?>&hellip;" data-text-error="<?php echo $speak->error; ?>." data-scope="#form-compose" data-target="#form-compose-preview"><i class="fa fa-fw fa-eye"></i> <?php echo $speak->preview; ?></a>
</div>
