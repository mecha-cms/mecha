...
<label class="grid-group">
  ...
  <span class="grid span-5"><textarea name="css" class="textarea-block code"><?php echo $cache['css']; ?></textarea></span>
</label>
<label class="grid-group">
  <span class="grid span-1 form-label"><?php echo $speak->manager->title_custom_js; ?></span>
  <span class="grid span-5"><textarea name="js" class="textarea-block code"><?php echo $cache['js']; ?></textarea></span>
</label>