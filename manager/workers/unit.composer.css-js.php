...
<label class="grid-group">
  ...
  <span class="grid span-5"><textarea name="css" class="textarea-block code"><?php echo Guardian::wayback('css', $default->css_raw); ?></textarea></span>
</label>
<label class="grid-group">
  <span class="grid span-1 form-label"><?php echo $speak->manager->title_custom_js; ?></span>
  <span class="grid span-5"><textarea name="js" class="textarea-block code"><?php echo Guardian::wayback('js', $default->js_raw); ?></textarea></span>
</label>
