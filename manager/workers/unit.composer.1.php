<label class="grid-group">
  ...
  <span class="grid span-5">
    <textarea name="content" class="textarea-block code MTE" placeholder="<?php echo $speak->manager->placeholder_content; ?>" data-mte-use-toolbar="true" data-mte-use-shortcut="true"><?php echo Text::parse(Guardian::wayback('content', $default->content_raw))->to_encoded_html; ?></textarea>
  </span>
</label>
