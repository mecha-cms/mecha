...
<ol class="page-list">
  ...
  <li class="page" id="page-<?php echo $page->id; ?>">
    <div class="page-header">
      <?php if($page->url !== '#'): ?>
      <a class="page-title" href="<?php echo $page->url; ?>" rel="nofollow" target="_blank"><?php echo $page->name; ?></a>
      <?php else: ?>
      <span class="page-title"><?php echo $page->name; ?></span>
      <?php endif; ?>
      <span class="page-time">
        <time datetime="<?php echo $page->date->W3C; ?>"><?php echo Date::format($page->time, 'Y/m/d H:i:s'); ?></time>
        <a href="<?php echo $page->permalink; ?>" title="<?php echo $speak->permalink; ?>" rel="nofollow" target="_blank">#</a>
      </span>
    </div>
