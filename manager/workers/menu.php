...
<form class="form-menu" action="<?php echo $config->url_current; ?>" method="post">
  ...
  <p><textarea name="content" class="textarea-block textarea-expand code MTE" data-MTE-config='{"tabSize":"    "}'><?php echo Text::parse(Guardian::wayback('content', $the_content), '->encoded_html'); ?></textarea></p>
