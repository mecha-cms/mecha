<?php $undeletable = array('404.php', 'article.php', 'comments.php', 'footer.php', 'header.php', 'index.php', 'manager.php', 'page.php', 'page-home.php'); echo $messages; ?>
