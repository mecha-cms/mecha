...
Guardian::plug('choked', function($input = null, $fallback = false) {
...
Guardian::checker('is_ip', function($input) {
    return filter_var($input, FILTER_VALIDATE_IP);
});

// Check for URL address
Guardian::checker('is_url', function($input) {
    return filter_var($input, FILTER_VALIDATE_URL);
});

// Check for email address
Guardian::checker('is_email', function($input) {
    return filter_var($input, FILTER_VALIDATE_EMAIL);
});

// Check for boolean value
Guardian::checker('is_boolean', function($input) {
