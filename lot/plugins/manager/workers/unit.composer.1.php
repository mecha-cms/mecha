...
<label class="grid-group">
  ...
  <?php echo Form::text('title', Guardian::wayback('title', $page->title_raw), $speak->manager->placeholder_title, array(
      'class' => 'input-block'
  )); ?>
  </span>
</label>
...
<?php if($page->link_raw): ?>
<label class="grid-group">
  <span class="grid span-1 form-label"><?php echo $speak->link; ?></span>
  <span class="grid span-5">
  <?php echo Form::text('link', Guardian::wayback('link', $page->link_raw), $config->protocol, array(
      'class' => 'input-block'
  )); ?>
  </span>
</label>
...
<label class="grid-group">
  ...
  <span class="grid span-5">
  <?php echo Form::textarea('description', Guardian::wayback('description', $page->description_raw), Config::speak('manager.placeholder_description_', strtolower($speak->{$segment})), array(
