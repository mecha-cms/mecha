...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(count($errors) === 0) {
        ...
        $_SESSION['mecha_notification'] = '<div class="message message-success cf"><p><i class="fa fa-thumbs-up"></i> Okay. Now you can login with these details:</p><p><strong>Username:</strong> ' . $_POST['username'] . '<br><strong>Password:</strong> ' . $_POST['password'] . '</p></div>';
