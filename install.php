...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(count($errors) === 0) {
        ...
        $_SESSION['mecha_notification'] = '<div class="messages"><p class="message message-success cf"><i class="fa fa-thumbs-up"></i> Okay. Now you can login with these details&hellip;</p><p><strong>Username:</strong> ' . $_POST['username'] . '<br><strong>Password:</strong> ' . $_POST['password'] . '</p></div>';
